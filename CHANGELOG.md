...
* `parseSession`, `parseAllSessions`, `ParsedSession.turns` and `ParsedSession.subagentTurns` are removed. Migrate to `readSession` (metadata) + `readSessionTurns` / `readSubagentTurns` (streamed turns).

### Code Refactoring

* streaming API redesign ([#61](https://github.com/Guiziweb/claude-code-data/issues/61)) ([8ae42be](https://github.com/Guiziweb/claude-code-data/commit/8ae42be0ce3498938ad78752a2990ee4e436984b))
...
* use Node 24 + setup-node@v6 for OIDC trusted publishing ([#55](https://github.com/Guiziweb/claude-code-data/issues/55)) ([e239a58](https://github.com/Guiziweb/claude-code-data/commit/e239a5824324e59054f9bb13cf8d75dd14f3b789))
...
* publish on npm + switch to OIDC trusted publishing ([#51](https://github.com/Guiziweb/claude-code-data/issues/51)) ([4eef7ef](https://github.com/Guiziweb/claude-code-data/commit/4eef7ef25b33e168ddd692f26f87ef0fc4508c24))
...
* move bump-minor-pre-major inside package config ([#46](https://github.com/Guiziweb/claude-code-data/issues/46)) ([04d2137](https://github.com/Guiziweb/claude-code-data/commit/04d21373001ec671074972579db8fc204c189249))
